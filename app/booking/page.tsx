  ...
  return (
    <div>
        ...
        <form className="flex flex-col sm:flex-row items-center gap-6 p-6">
          <div className="flex-1">
            ...
            <div className="relative">
              <select className="w-full border-b border-purple-200 text-gray-700 focus:outline-none appearance-none bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {buses.map((bus) => (
          <div key={bus.id} className="bg-[#F4F4F4] border border-[#D2D2D2] rounded-lg p-6 mb-4 hover:shadow-lg transition-shadow">
            <div className="flex flex-col sm:flex-row justify-between gap-6">
              <div className="w-full">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <h3 className="text-2xl font-semibold text-gray-800">{bus.operator}</h3>
                    <span className="text-lg text-gray-500">{bus.date}</span>
                    <span className="text-lg text-gray-500"><span className="font-semibold text-black text-xl">{bus.departureTime}</span> AM</span>
                    <span className="text-lg text-gray-500">{bus.duration}</span>
                    <span className="text-2xl font-semibold text-purple-800">{bus.price}</span>
                </div>
