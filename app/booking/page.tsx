    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto py-4 px-4">
        <form className="flex flex-col sm:flex-row items-center gap-6 p-6">
          <div className="flex-1">
            ...
            <div className="relative">
              ...
              <Icon
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 w-8 h-8 text-purple-900"
              />
            </div>
          </div>
          <div className="flex-1">
          ...
          <button className="bg-purple-800 text-white px-6 py-2 rounded-md hover:bg-primary-100 transition-colors">
            Search
          </button>
        </form>
      </div>
