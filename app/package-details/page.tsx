            ...
            <div className="sticky top-32 bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <div className="mt-8 flex flex-col gap-2">
                  <Link href="/booking">
                    <button className="w-full bg-purple-800 hover:bg-purple-900 text-white py-3 px-4 rounded-md font-medium transition-colors flex items-center justify-center gap-2">
